...
var bigramTokeniser = function bigramTokeniser(obj, metadata) {
  ...
  for (var i = 0; i <= str.length - 2; i++) {
    var tokenMetadata = lunr__WEBPACK_IMPORTED_MODULE_0__.utils.clone(metadata) || {};
...
var queryNgramSeparator = function queryNgramSeparator(query) {
...
var index = '../post/index.json';

var initLunr = function initLunr() {
...
var initUI = function initUI() {
  ...
  searchBox.addEventListener('keyup', function (event) {
    var searchResultsArea = document.querySelector('#searchResults');
    var query = event.currentTarget.value; // Only trigger a search when 2 chars. at least have been provided
...
var renderResults = function renderResults(results) {
  ...
  var BODY_LENGTH = 100;
  var MAX_PAGES = 10; // Clear search result
  ...
  var instance = new (mark_js__WEBPACK_IMPORTED_MODULE_1___default())(document.querySelector('#searchResults')); // Only show the ten first results
...
/******/ 	__webpack_require__.O(undefined, ["static/css/tailwind"], () => (__webpack_require__("./src/js/search.js")))
